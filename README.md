...
```javascript
sstdevpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevpn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-sstdevpn/tags). For example,

```javascript
sstdevpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevpn@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sstdevpn = require( 'path/to/vendor/umd/stats-base-sstdevpn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-sstdevpn@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-sstdevpn.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-sstdevpn

[test-image]: https://github.com/stdlib-js/stats-base-sstdevpn/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-sstdevpn/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-sstdevpn/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-sstdevpn?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-sstdevpn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-sstdevpn/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-sstdevpn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-sstdevpn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-sstdevpn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-sstdevpn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-sstdevpn/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-sstdevpn/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-sstdevpn/main/LICENSE
